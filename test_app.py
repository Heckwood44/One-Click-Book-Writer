...
class TestBookWriterApp:
    def __init__(self, root):
        self.root = root
        self.root.title("One Click Book Writer - Test App (Keine API-Keys erforderlich)")
    ...
    def setup_ui(self):
        ...
        # Titel
        title_label = ttk.Label(main_frame, text="One Click Book Writer - Test Application", 
                               font=("Arial", 16, "bold"))
        ...
        # Template-Editor
        template_label = ttk.Label(template_frame, text="JSON Template:", font=("Arial", 12, "bold"))
        ...
        ttk.Button(button_frame, text="Beispiel laden", command=self.load_example).pack(side=tk.LEFT, padx=(0, 10))
        ttk.Button(button_frame, text="Validieren", command=self.validate_template).pack(side=tk.LEFT, padx=(0, 10))
        ttk.Button(button_frame, text="Demo-Generierung", command=self.demo_generation).pack(side=tk.LEFT)
        ...
        # Demo-Output
        demo_label = ttk.Label(demo_frame, text="Demo-Generierung:", font=("Arial", 12, "bold"))
        demo_label.pack(anchor=tk.W, pady=(10, 5))
        
        self.demo_text = scrolledtext.ScrolledText(demo_frame, height=20, font=("Consolas", 10))
    ...
    def validate_template(self):
        ...
        try:
            ...
            if missing_fields:
                messagebox.showwarning("Validierung", f"Fehlende Felder: {', '.join(missing_fields)}")
